...
MASA::steadytaylorvortex3d<Scalar>::steadytaylorvortex3d()
{
  this->mmsname = "steadytaylorvortex3d";
  this->dimension = 3;
...
template <typename Scalar>
int MASA::steadytaylorvortex3d<Scalar>::init_var()
{
  int err = 0;
...
template <typename Scalar>
Scalar MASA::steadytaylorvortex3d<Scalar>::eval_q_u(Scalar x1, Scalar y1, Scalar z1)
{
  ...
  U[0]       = -std::cos(20.0*piVal*x) * std::sin(20.0*piVal*y) * std::sin(20.0*piVal*z);
  U[1]       =  std::sin(20.0*piVal*x) * std::cos(20.0*piVal*y) * std::sin(20.0*piVal*z);
  U[2]       = -std::sin(20.0*piVal*x) * std::sin(20.0*piVal*y) * std::cos(20.0*piVal*z);
  ADScalar P = -1.0/4.0 * (std::cos(40.0*piVal*x) + std::cos(40.0*piVal*y) + std::cos(40.0*piVal*z));
...
template <typename Scalar>
Scalar MASA::steadytaylorvortex3d<Scalar>::eval_q_v(Scalar x1, Scalar y1, Scalar z1)
{
  typedef DualNumber<Scalar, NumberVector<NDIM, Scalar> > FirstDerivType;
  typedef DualNumber<FirstDerivType, NumberVector<NDIM, FirstDerivType> > SecondDerivType;
  typedef DualNumber<SecondDerivType, NumberVector<NDIM, SecondDerivType> > ThirdDerivType;
...
template <typename Scalar>
Scalar MASA::steadytaylorvortex3d<Scalar>::eval_q_w(Scalar x1, Scalar y1, Scalar z1)
{
  typedef DualNumber<Scalar, NumberVector<NDIM, Scalar> > FirstDerivType;
  typedef DualNumber<FirstDerivType, NumberVector<NDIM, FirstDerivType> > SecondDerivType;
  typedef DualNumber<SecondDerivType, NumberVector<NDIM, SecondDerivType> > ThirdDerivType;
...
template <typename Scalar>
Scalar MASA::steadytaylorvortex3d<Scalar>::eval_exact_u(Scalar x, Scalar y1, Scalar z1)
{
  ...
  Scalar exact_u;
  exact_u = -std::cos(20.0*piVal*x) * std::sin(20.0*piVal*y1) * std::sin(20.0*piVal*z1);
  return exact_u;
}

// public method
template <typename Scalar>
Scalar MASA::steadytaylorvortex3d<Scalar>::eval_exact_v(Scalar x1, Scalar y, Scalar z1)
{
  typedef DualNumber<Scalar, Scalar> OneDDerivType;
  ...
  Scalar exact_v;
  exact_v = std::sin(20.0*piVal*x1) * std::cos(20.0*piVal*y) * std::sin(20.0*piVal*z1);
  return exact_v;
}

// public method
template <typename Scalar>
Scalar MASA::steadytaylorvortex3d<Scalar>::eval_exact_w(Scalar x1, Scalar y1, Scalar z)
{
  typedef DualNumber<Scalar, Scalar> OneDDerivType;
  OneDDerivType x = OneDDerivType(x1,1);
  OneDDerivType y = OneDDerivType(y1,1);
  ...
  Scalar exact_w;
  exact_w = -std::sin(20.0*piVal*x1) * std::sin(20.0*piVal*y1) * std::cos(20.0*piVal*z);
  return exact_w;
}

// public method
template <typename Scalar>
Scalar MASA::steadytaylorvortex3d<Scalar>::eval_exact_p(Scalar x, Scalar y, Scalar z)
{

  double piVal = std::acos(-1.0);

  Scalar P = -1.0/4.0 * (std::cos(40.0*piVal*x) + std::cos(40.0*piVal*y) + std::cos(40.0*piVal*z));
  return P;
}
...
MASA_INSTANTIATE_ALL(MASA::steadytaylorvortex3d);
